(function ($) {
    ...
    $(function () {
            ...
            if (state === 'ready') {
                ...
                if (stats.uploadFailNum) {
                    text = '已成功上传' + stats.successNum + '张图片，' +
                        stats.uploadFailNum + '张图片上传失败，<a class="retry" href="#">重新上传</a>失败图片或<a class="ignore"' +
                        ' href="#">忽略</a>'
                }
        ...
        uploader.onUploadSuccess = function (file, response) {
            // 自定义上传成功处理逻辑
            var photo_name = response.data.objectName;
            ...
            $("#upload-cover-container").append(
                ...
                photo_name + '?imageView2/1/w/100/h/100" title="待选封面" />' +
