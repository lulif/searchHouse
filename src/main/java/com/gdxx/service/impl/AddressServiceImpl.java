...
import com.gdxx.repository.SubwayRepository;
import com.gdxx.repository.SubwayStationRepository;
...
public class AddressServiceImpl implements AddressService {
    ...
    private static final String BAIDU_MAP_KEY = "KGPOhDf6okL4OYQZoQjnGFyzCnASS5E6";
    ...
    public ServiceMultiResult<SupportAddressDTO> findAllCities() {
        ...
        List<SupportAddressDTO> addressDTOList = new ArrayList<>();
        for (SupportAddress supportAddress : addressList) {
            SupportAddressDTO target = modelMapper.map(supportAddress, SupportAddressDTO.class);
            addressDTOList.add(target);
        }
    ...
    public ServiceResult lbsUpload(BaiduMapLocation location, String title, String address, long houseId, int price, int area) {
        ...
        nvps.add(new BasicNameValuePair("coord_type", "3")); // 坐标系类型:百度坐标系
        nvps.add(new BasicNameValuePair("geotable_id", "203170"));
    ...
    private boolean isLbsDataExists(long houseId) {
        ...
        sb.append("geotable_id=").append("203170").append("&")
                .append("ak=").append(BAIDU_MAP_KEY).append("&")
                .append("coord_type=").append(3).append("&")
